...
const contenedorPastEvents = document.getElementById("ContenedorCardsPastEvents");
const fecha = data.currentDate
const contenedorPastEventsDos = document.getElementById("ContenedorCheckPastEvents");
