...
const contenedorUpcomingEvents = document.getElementById("ContenedorCardsUpcomingEvents")
const fecha = data.currentDate
const contenedorUpcomingEventsDos = document.getElementById("ContenedorCheckUpcomingEvents");
